...
#' The recommended way to authenticate with Azure AD Graph is via the [get_azure_login] function, which creates a new instance of this class.
#'
...
#'
#' @seealso
#' [create_azure_login], [get_azure_login], [az_rm]
#'
